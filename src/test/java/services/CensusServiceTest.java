...
public class CensusServiceTest extends AbstractTest {
	...
	public void createCensus() throws ParseException, FileNotFoundException, IOException {
		...
		caught = null;
		try {
			authenticate("admin1"); // Nos autenticamos como el usuario
			Census c_1 = censusService.create("Z:\\ExamenWS\\Censo\\votacion.txt");
